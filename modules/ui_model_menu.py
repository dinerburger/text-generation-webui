                ...
                with gr.Blocks():
                    with gr.Row():
                        with gr.Column():
                            ...
                            shared.gradio['tf_cache_quant_algo'] = gr.Dropdown(label='tf_cache_quant_algo', value=shared.args.tf_cache_quant_algo, info='KV cache quantization algorithm. HQQ requires additional dependencies.', choices=['none', 'quanto', 'hqq'])
